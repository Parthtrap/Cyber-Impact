...
const FrontPage = () => {
	...
	return (
		<div className="user-front-page-body">
			<div className="user-frontpage-filter-search">
				<div className={filterStyle}>
					<select name="category-select" className="selection category-select" id="category-select" onChange={categorySelect}>
					...
					<select name="profession-select" className="selection profession-select" id="profession-select" onChange={professionChange}>
					...
					<select name="filter-select" className="selection filter-select" id="filter-select" onChange={filterChange}>
					...
					<button id="filter-button" className="filter-button" onClick={filterButtonPressed}>
						Filter
						<span></span>
						<span></span>
						<span></span>
					...
					<button id="filter-button" className="filter-button" onClick={searchFilterToggleButton}>
						Search
						<span></span>
						<span></span>
						<span></span>
				...
				<div className={searchStyle}>
					...
					<div className="wrapper">
						...
						/>
						<input className="search-edittext" id="search-edittext" placeholder="Search" type="text" onChange={searchBarChange} value={searchBarText} />
						<img
					...
					<button id="filter-button" className="filter-button" onClick={SearchButtonPressed}>
						Search
						<span></span>
						<span></span>
						<span></span>
